...
const _5_2Handlers = Alexa.CreateStateHandler(states._5_2,{
    ...
    "E_BIntent":function() {
        this.handlers.state = states._6_2;
        this.emitWithState("Story");
    },
...
const _6_2Handlers = Alexa.CreateStateHandler(states._6_2,{
    ...
    "F_BIntent":function() {
        this.handlers.state = states._7_3;
        this.emitWithState("Story");
    },
...
const _8_3Handlers = Alexa.CreateStateHandler(states._8_3Handlers,{
    "Story":function() {
...
exports.handler = (event, context) => {
    ...
    alexa.registerHandlers(handlers, startHandlers, stopHandlers, gameoverHandlers, exitHandlers, 
                            ...
                            _7_1Handlers, _7_2Handlers, _7_3Handlers, _8_1Handlers, _8_3Handlers,
                            _9_1Handlers, _10_1Handlers);
    alexa.execute();
};
